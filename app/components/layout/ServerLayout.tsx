  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[var(--background)]">
      ...
      `}>
        ...
        {/* Channel Sidebar - 300px */}
        <div className="w-[300px] h-full bg-[var(--surface)] shadow-[4px_0_var(--shadow-sm)]">
          <ChannelsSidebar />
        </div>
      </div>
      ...
      <aside className={`
        ...
        transition-transform duration-300
        ${isUsersSidebarOpen ? 'translate-x-0' : 'translate-x-full lg:translate-x-0'}
        z-20
      `}>
        <MembersSidebar />
      </aside>
